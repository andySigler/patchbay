...
The HTML5 interface uses [hammer.js](http://hammerjs.github.io/) for touch events, and connects over BLE using Rand Dusing's [cordova plugin](https://github.com/randdusing/BluetoothLE).